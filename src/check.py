...
y1 = np.load('dataset/processed/1d/withNoise/y_train.npy')
y2 = np.load('dataset/processed/1d/withNoise/y_val.npy')
y3 = np.load('dataset/processed/1d/withNoise/y_test.npy')
